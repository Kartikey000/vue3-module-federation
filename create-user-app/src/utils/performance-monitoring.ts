...
export class PerformanceMonitor {
  ...
  /**
   * Track user interaction time (form submission, save, etc.)
   */
...
// Create singleton instance for create-user-app
export const perfMonitor = new PerformanceMonitor('create-user-app')
